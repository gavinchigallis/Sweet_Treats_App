...
class FirstAidPage extends StatefulWidget {
  ...
  * @return: void
  */
  FirstAidPage.withData(int product_id){
  ...
  */
  ...
  State<StatefulWidget> createState() {
      if(this._product_id==null){
          return _FirstAidPage();
      }else{
          return _FirstAidPage._withData(this._product_id);
      }
  }
}
...
* @return: void
*/
class _FirstAidPage extends State<FirstAidPage> with WidgetsBindingObserver{
    /*[Attributes]*/
    int _state_id = 0;
    ...
    * @return: void
    */
    _FirstAidPage._withData(int product_id)
    {
        this._product_id = product_id;
    }
    ...
    */
    ...
    void initState(){
        ...
        this._getFirstAid(this._product_id);
    ...
    * @return: void
    */
    Future<void> _getFirstAid(int product_id) async {
        this.utility.Custom_Print("START: _getFirstAid");
        //Variables
        ...
        this._productService.getFirstAid(product_id)
        .then((value) {
            // Run extra code here
        ...
        this.utility.Custom_Print("STOP: _getFirstAid");
    }
}